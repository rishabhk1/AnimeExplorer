    ...
    <div className='relative min-h-screen isolate overflow-hidden border-b border-gray-200 bg-white'>
      ...
      <div className='mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex gap-16 lg:px-8 lg:py-24'>
          <div className='h-full w-full flex flex-col items-center gap-4'>
              <h1 className='tracking-tight text-4xl sm:text-6xl font-bold font-mono'>
                AnimeExplorer
              </h1>
              <p className='max-w-xl text-center text-lg text-slate-700 font-mono'>
                Discover new anime by entering genres or titles<br/>Be specific to get best results
              </p>
